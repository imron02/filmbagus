...
import { styles, spacer } from '../styles/movie_style';
...
const MovieScreen = ({ route, genres }: MovieScreenProps) => {
      ...
      <ScrollView style={styles.contentWrapper}>
        ...
        <Animatable.View
          ...
          <View style={styles.subtitleContainer}>
            ...
            <Text style={[styles.vote, styles.subtitle]}>{releaseDate}</Text>
          </View>
          <View style={spacer(2).space} />
          <Text style={[styles.vote, styles.subtitle]}>
            {genreNames.join(', ')}
          </Text>
